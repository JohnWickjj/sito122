...
<html lang="es">
    <head>
        ...
        <title>Agregar cliente/Eventos Gino</title>
...
<div id="grancontenedor">
    ...
    <div class="contenedor" style="border: 1px solid #3f5f7a;">
        <form action="index.php?c=clientes&f=new" method="POST" name="formAcceso" id="formAcceso">
            ...
            <div id="grid2">
                ...
                <a class="boton" href="index.php?c=clientes&f=index">Cancelar</a>
            </div>
        </form>
    </div>
</div>
